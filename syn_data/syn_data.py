...
# -----------------------------
USD_PATH = "/home/leonard/Downloads/rear_wheel.usd"  # TODO anpassen
...
class PseudoVehicle:
    ...
    def step(self, dt: float) -> None:
        ...
        q_total = _quat_mul_wxyz(q_yaw, q_spin)
...
class DatasetSceneCfg(InteractiveSceneCfg):
    ...
    camera = CameraCfg(
        ...
        offset=CameraCfg.OffsetCfg(
            pos=(-2.0, 0.0, 1),
            rot=(0.6533, -0.2706, 0.2706, -0.6533),  # quat (w,x,y,z) in usd-konvention; ggf. anpassen
            convention="usd",
        ),
    )
...
def run() -> None:
    ...
    vehicle = PseudoVehicle(
        ...
        v_mps=1.0,
        wheel_radius_m=0.35,  # ggf. an dein Wheel anpassen
        spin_axis="y",
    )
